  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
            <h1 style="text-align: center; padding: 2%">Shto Administrator</h1>
    ...
    <div class="content"  style="padding-right:20%; padding-left: 20%; padding-bottom: 5%;">
           ...
           <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form enctype="multipart/form-data"  action="addadmin.php" method="post" name="form1"  >
                <div class="card-body">
    ...
    border-color: #001f42;" type="submit"  name="addadmin" class="btn btn-primary">Shto</button>
                </div>
              </form>
            </div>
            </div>
