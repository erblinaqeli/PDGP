...
include_once("konfigurimi.php");
    ...
    { 
      ...
      if(empty($firstname) || empty($password)) {  
        ...
        //updating the table
        $rezultati = mysqli_query($lidh,"UPDATE users_adm SET firstname='$firstname', lastname='$lastname', username='$username', password='$password' WHERE id =$id");
    ...
    $rezultati = mysqli_query($lidh,"SELECT * FROM users_adm WHERE id=$id");
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
            <h1 style="text-align: center; padding: 2%">Modifiko Detajet e  Admin Përdoruesit</h1>
    ...
    <div class="content"  style="padding-right:20%; padding-left: 20%">
     <div class="card-header" style="padding-bottom: 5%; ">
           <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form enctype="multipart/form-data"  action="update_usersadm.php" method="post" name="form1" >
                <div class="card-body">
                  <div class="form-group" >
                    ...
                    <input type="text" class="form-control" name="lastname" placeholder="" value='<?php echo $lastname;?>' >
                     ...
                     <div class="form-group">
                    <label for="exampleInputEmail1">Emri përdoruesit</label>
