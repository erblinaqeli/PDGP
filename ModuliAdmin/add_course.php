  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
            <h1 style="text-align: center; padding: 2%">Shto Lëndë</h1>
    ...
    <div class="content"  style="padding-right:20%; padding-left: 20%">
      <div class="container-fluid">
           <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form enctype="multipart/form-data"  action="addcourse.php" method="post" name="form1"  >
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label for="exampleInputEmail1">Emri Lëndës</label>
                    <input type="text" class="form-control" name="name" placeholder=""  >
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Përshkrimi i Lëndës</label>
    ...
    border-color: #001f42;"type="submit"  name="shtolende" class="btn btn-primary">Shto</button>
                </div>
              </form>
            </div>
            </div>
