...
<a href="add_course.php" class="btn-sm btn-primary" style="background-color: #001f42!important;border-color:#001f42!important; padding: 1%; float: right;margin-right: 5%; margin-bottom: 2%">+ Shto Lëndë</a>
            <div class="card-body">
              <br>
          <br>
          <h3 class="card-title">&nbsp Lista e Lëndëve</h3>
          <br><br>
           <div class="container-fluid">
       <table id="example1" class="table table-bordered table-striped">
          ...
          <?php 
          $i = 1;
            $qry = $lidh->query("SELECT * from `course_list` order by `name` asc ");
