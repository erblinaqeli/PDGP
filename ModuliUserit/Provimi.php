  ...
  <div class="content-wrapper">
    ...
    <div class="content">
      <div class="container-fluid">
         ...
         <a href="add_paper.php" class="btn-sm btn-primary" style="background-color: #001f42!important;border-color:#001f42!important; padding: 1%; float: right;margin-right: 5%; margin-bottom: 2%">+ Shto Provim</a>
            <div class="card-body">
              <br>
          <br>
      ...
      <table id="example1" class="table table-bordered table-striped">
        ...
        <tbody>
          <?php 
          $i = 1;
            $qry = $lidh->query("SELECT q.*,CONCAT(cc.name,' - ',c.name) as `class` from `question_paper_list` q inner join class_list c on q.class_id = c.id inner join course_list cc on c.course_id = cc.id where q.delete_flag = 0 and q.user_id = '$kyc_perd' order by CONCAT(cc.name,' - ',c.name) asc, q.`title` asc ");
