	...
	<body class="is-preload">
        ...
        if(isset($_POST['shtolende'])) {	
            ...
            if(empty($name)) {			
                ...
                $result = mysqli_query($lidh, "INSERT INTO course_list (`id`, `user_id`, `name`, `description`, `delete_flag`, `status`, `date_created`, `date_updated`) VALUES('','$kyc_perd','$name','$description','','',NOW(),'')");
